...
def create_transport(
    ...
    **Note**: model prediction defaults to velocity
    ...
    path_choice = {
        ...
        "GVP": PathType.GVP,
        "VP": PathType.VP,
        "SemanticRecon": PathType.SEMANTIC_RECON,
    }
    ...
    elif (path_type in [PathType.GVP, PathType.LINEAR, PathType.SEMANTIC_RECON] and model_type != ModelType.VELOCITY):
        train_eps = 1e-3 if train_eps is None else train_eps
        sample_eps = 1e-3 if train_eps is None else sample_eps
    else: # velocity & [GVP, LINEAR, SEMANTIC_RECON] is stable everywhere
        train_eps = 0
        sample_eps = 0
    ...
    state = Transport(
        ...
        normalize_channel_weight=normalize_channel_weight,
    )
